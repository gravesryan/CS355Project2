...
exports.getAll = function(callback) {
    var query = 'SELECT * FROM superbowl_wins ORDER BY year;';
...
exports.getById = function(team, year, callback) {
    var query = 'SELECT * FROM superbowl_wins where team = ? AND year = ?';
...
exports.insert = function(params, callback) {
    var query = 'INSERT INTO superbowl_wins (team, year) VALUES (?, ?)';
...
exports.delete = function(team, year, callback) {
    var query = 'DELETE FROM superbowl_wins WHERE team = ? AND year = ?';
    var queryData = [team, year];
...
exports.update = function(params, callback) {
    var query = 'UPDATE superbowl_wins SET team = ?, city = ? WHERE team = ? AND year = ?';
